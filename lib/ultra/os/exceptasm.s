...
#if !defined(__sgi) && !defined(EGCS_GCC)
.set gp=64
#endif
...
/* IDO assembler throws an error due to eret instruction without noreorder */
/* These were added only for IDO because iQue doesn't match with them */
1:
#ifdef __sgi
    .set noreorder
#endif
